  ...
  return (
    <div className="mx-auto flex h-[calc(100dvh-5rem)] sm:h-[calc(100dvh-6rem)] max-w-[1600px] gap-0 lg:gap-4 px-0 lg:px-4">
      ...
      <aside className={clsx(
        'fixed lg:static inset-0 lg:inset-auto z-[9999] lg:z-auto w-4/5 max-w-xs lg:w-80 shrink-0 flex-col gap-4 overflow-y-auto lg:rounded-xl border-r lg:border border-slate-200/70 dark:border-slate-800 bg-white dark:bg-slate-900 p-4 shadow-card',
      ...
      <div className="relative flex-1 overflow-hidden rounded-none lg:rounded-xl border-0 lg:border border-slate-200/70 dark:border-slate-800 shadow-card">
        ...
        {!showSidebar && (
          <button
            ...
            className="absolute top-4 left-4 z-[1001] lg:hidden flex h-10 w-10 items-center justify-center rounded-xl bg-white text-slate-600 shadow-popup hover:bg-slate-50 cursor-pointer dark:bg-slate-800 dark:text-slate-200"
        ...
        {/* Légende */}
        <div className="glass hidden lg:block absolute left-4 top-4 z-[1000] rounded-xl p-3 text-xs shadow-card">
